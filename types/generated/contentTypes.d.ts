...
export interface ApiCompanyInfoCompanyInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    CompnayName: Attribute.String & Attribute.Required;
...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    showLog: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    ...
    >;
    socialLinks: Attribute.Component<'config.social-link', true>;
    showProfileLink: Attribute.Boolean &
      Attribute.Required &
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    >;
    seo: Attribute.Component<'seo.seoinformation', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
